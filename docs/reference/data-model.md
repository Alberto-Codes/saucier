...
states that mother. A derivative that states its mother therefore cannot
replace it. The surviving hits keep source order, because the source states a
base before its derivatives. An empty result leaves the mother uncatalogued
in that witness.
