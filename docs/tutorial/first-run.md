...
**73 unresolved** is the honest score, and it is the most interesting number
...
depth because a parent may be any catalogued sauce, not only a mother:
...
The 73 unresolved preparations are the reason there will be one.
