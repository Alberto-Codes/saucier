"""Docs-reference gate: dotted ``saucier.*`` paths in docs must exist.
...
_REF = re.compile(r"\bsaucier(?:\.[A-Za-z_][A-Za-z0-9_]*)+\b")
...
def main(argv: list[str]) -> int:
    """Check every dotted saucier reference in the doc set.
